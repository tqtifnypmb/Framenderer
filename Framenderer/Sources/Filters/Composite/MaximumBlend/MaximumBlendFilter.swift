...
public class MaximumBlendFilter: DualInputFilter {
    
    /**
     init a [Maximum blend](https://en.wikipedia.org/wiki/Blend_modes) filter
     
     result = max(canvas, _otherImage_)
